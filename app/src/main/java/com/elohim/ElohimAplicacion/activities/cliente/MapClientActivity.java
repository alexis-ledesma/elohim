...
public class MapClientActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private List<Marker> mTrabajadoresMarkers = new ArrayList<>();
    ...
    private Button mButtonRequestTrabajador;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonRequestTrabajador = findViewById(R.id.btnRequestTrabajador);
        ...
        mButtonRequestTrabajador.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void requestTrabajador() {
    ...
    private void instanceAutocompleteDestination(){
        mAutocompleteDestination = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.places_autocompleteDestination);
        ...
        mAutocompleteDestination.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                Log.d("PLACES", "Lat:" + mDestinationLatLng.latitude);
                Log.d("PLACES", "Lng:" + mDestinationLatLng.longitude);
            }
    ...
    private void getActiveTrabajadores() {
        mGeofireProvider.getActiveTrabajadores(mCurrentLatLng).addGeoQueryEventListener(new GeoQueryEventListener() {
            @Override
            public void onKeyEntered(String key, GeoLocation location) {
                for (Marker marker : mTrabajadoresMarkers) {
                ...
                LatLng trabajadorLatLng = new LatLng(location.latitude, location.longitude);
                Marker marker = mMap.addMarker(new MarkerOptions().position(trabajadorLatLng).title("trabajador disponible").icon(BitmapDescriptorFactory.fromResource(R.drawable.icono_moto)));
                marker.setTag(key);
                mTrabajadoresMarkers.add(marker);
            }
            ...
            public void onKeyExited(String key) {
                for (Marker marker : mTrabajadoresMarkers) {
                    if (marker.getTag() != null) {
                        if (marker.getTag().equals(key)) {
                            marker.remove();
                            mTrabajadoresMarkers.remove(marker);
                            return;
                        }
                    }
                }
